...
const main = () => {
  return (
    <div>      
      <section className="grid gap-8 md:grid-cols-2 md:items-center md:text-left  sm:max-2xl:p-4 border-b-[1px] border-b-gray-600">
            <div className="pt-8 pr-8 pl-8 pb-8 items-center justify-between">
              <div className="flex-col items-start gap-8">               
                <p className="text-cyan-50 text-xl font-bold leading-10 self-stretch" >Hey, I'm Jay</p>
                <br />
                <h1 className="text-cyan-50 text-7xl font-bold leading-10 self-stretch"> 
                  ...
                  <br />
                  <p className="text-cyan-50 text-2xl font-normal leading-9">
